...
// Create the Dark tile layer that will be a background of the map.
...
// Create the major earthquakes layer for the map.
...
d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/4.5_week.geojson").then(function(data) {
    ...
    // Create a GeoJSON layer with the retrieved data that adds a circle to the map sets the style of the circle,
